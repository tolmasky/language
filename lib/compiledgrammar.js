...
function CompiledGrammar(/*String*/ aGrammar)
{
    ...
    var r = buildRulesFromSyntaxTree(tree);
    compileOpcodeTableFromRules(this.table, this.nameToUID, r.rules, r.firstUsageNodes)
...
function compileOpcodeTableFromRules(/*Array*/ table, /*Object*/ nameToUID, /*Object*/ rules, /*Object*/ firstUsageNodes)
{
    table[0] = [0, "source", 1];
    table.length = 1;
    ...
    traverseRulesAnchoredAtName(rules, firstUsageNodes, "start", process);
    traverseRulesAnchoredAtName(rules, firstUsageNodes, "%start", process);
...
function traverseRulesAnchoredAtName(/*Object*/ rules, /*Object*/ firstUsageNodes, /*String*/ aName, /*Function*/ process)
{
    var index = 0,
        stack = [aName];
    ...
    while (index < stack.length)
    {
        ...
        if (!rule)
            throw firstUsageNodes[hash].message("Rule \"" + hash +  "\" is not defined.");
...
function buildRulesFromSyntaxTree(/*SyntaxNode*/ aNode)
{
    ...
    walker.exitedNode = function(aNode)
    {
        ...
        if (builder)
            aNode.hash = builder(aNode, rules, firstUsageNodes);
    }
    ...
    return {rules: rules, firstUsageNodes: firstUsageNodes};
}
...
RULE_BUILDERS["Identifier"] = function(aNode, rules, firstUsageNodes)
{
    var hash = aNode.innerText();

    if(!firstUsageNodes[hash])
        firstUsageNodes[hash] = aNode;
